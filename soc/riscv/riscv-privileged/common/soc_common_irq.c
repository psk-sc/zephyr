...
#elif DT_HAS_COMPAT_STATUS_OKAY(riscv_scr_ipic)
#define riscv_ic_irq_enable riscv_ipic_irq_enable
#define riscv_ic_irq_disable riscv_ipic_irq_disable
#define riscv_ic_irq_is_enabled riscv_ipic_irq_is_enabled
#endif
